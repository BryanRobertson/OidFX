...
#ifndef TERRAINDEMO_EFFECTTEST_H
#define TERRAINDEMO_EFFECTTEST_H
...
namespace TerrainDemo
{
	...
	//!@class	EffectTest
	//!@brief	Class designed to test an effect by displaying the effect on a quad
	class EffectTest : public Renderer::IRenderable
	{
		public:
            ...
            // Constructor
            //=========================================================================
			inline EffectTest ( Renderer::IRenderer& renderer, Renderer::EffectManager& effectManager, const Char* effectName );
    ...
    //=========================================================================
    //! @function    EffectTest::EffectTest
    //! @brief       EffectTest constructor
    //!              
    //! @param       renderer 
    //! @param       effectManager 
    //! @param       effectName 
    ...
    //! @throw       
    //=========================================================================
	EffectTest::EffectTest ( Renderer::IRenderer& renderer, 
