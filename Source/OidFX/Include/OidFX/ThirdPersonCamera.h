...
//! @brief        Class for a camera with a third-person view
//!               
//!               
//!               
...
#ifndef OIDFX_THIRDPERSONCAMERA_H
#define OIDFX_THIRDPERSONCAMERA_H
...
namespace OidFX
{
	...
	//!@brief	Class representing a third-person camera
	//!			
	//!			A third person camera follows an entity at a set distance
	class ThirdPersonCamera : public Camera
	{
		...
		public:
            ...
            // Constructors
            //=========================================================================
			ThirdPersonCamera ( boost::shared_ptr<EntityNode> entity, Scene& scene, Math::EHandedness rendererHandedness );
