//======================================================================================
//! @file         Main.cpp
//! @brief        Main application for effect viewer
//!               
//!               
//!               
...
{
	boost::shared_ptr<OidFX::GameApplication> game(new EffectViewer::EffectViewerApplication());

	return game->Run ( commandLineStrings, "Effect Viewer", "Effect viewer.txt" );	
}
//end GameMain
